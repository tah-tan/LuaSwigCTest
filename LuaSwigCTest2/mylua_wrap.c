...
#define SWIG_name      "mylua"
#define SWIG_init      luaopen_mylua
#define SWIG_init_user luaopen_mylua_user

#define SWIG_LUACODE   luaopen_mylua_luacode
...
static int _wrap_swap(lua_State* L) {
  ...
  if(!lua_isnumber(L,1)) SWIG_fail_arg("swap",1,"int *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("swap",2,"int *");
...
static int _wrap_array_write7(lua_State* L) {
  int SWIG_arg = 0;
  unsigned long *arg1 = (unsigned long *) 0 ;
  int arg2 ;
  
  SWIG_check_num_args("array_write7",1,1)
  arg1 = SWIG_get_ulong_num_array_var(L,1,&arg2);
  if (!arg1) SWIG_fail;
  array_write7(arg1,arg2);
  
  SWIG_write_ulong_num_array(L,arg1,arg2); SWIG_arg++; 
  SWIG_FREE_ARRAY(arg1);
  return SWIG_arg;
...
static int _wrap_array_write8(lua_State* L) {
  int SWIG_arg = 0;
  short *arg1 = (short *) 0 ;
  int arg2 ;
  int result;
  
  SWIG_check_num_args("array_write8",1,1)
  arg1 = SWIG_get_short_num_array_var(L,1,&arg2);
  if (!arg1) SWIG_fail;
  result = (int)array_write8(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  SWIG_write_short_num_array(L,arg1,arg2); SWIG_arg++; 
  SWIG_FREE_ARRAY(arg1);
  return SWIG_arg;
...
static int _wrap_array_write(lua_State* L) {
  int SWIG_arg = 0;
  int *arg1 = (int *) 0 ;
  int arg2 ;
  
  SWIG_check_num_args("array_write",1,1)
  arg1 = SWIG_get_int_num_array_var(L,1,&arg2);
  if (!arg1) SWIG_fail;
  array_write(arg1,arg2);
  
  SWIG_write_int_num_array(L,arg1,arg2); SWIG_arg++; 
  SWIG_FREE_ARRAY(arg1);
  return SWIG_arg;
...
static int _wrap_array_write3(lua_State* L) {
  int SWIG_arg = 0;
  int *arg1 = (int *) 0 ;
  int arg2 ;
  int arg3 ;
  
  SWIG_check_num_args("array_write3",2,2)
  if(!lua_isnumber(L,2)) SWIG_fail_arg("array_write3",2,"int");
  arg1 = SWIG_get_int_num_array_var(L,1,&arg2);
  if (!arg1) SWIG_fail;
  arg3 = (int)lua_tonumber(L, 2);
  array_write3(arg1,arg2,arg3);
...
static int _wrap_array_write4(lua_State* L) {
  int SWIG_arg = 0;
  int arg1 ;
  int *arg2 = (int *) 0 ;
  int arg3 ;
  
  SWIG_check_num_args("array_write4",2,2)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("array_write4",1,"int");
  arg1 = (int)lua_tonumber(L, 1);
  arg2 = SWIG_get_int_num_array_var(L,2,&arg3);
  if (!arg2) SWIG_fail;
  array_write4(arg1,arg2,arg3);
  
  SWIG_write_int_num_array(L,arg2,arg3); SWIG_arg++; 
...
static const struct luaL_reg swig_commands[] = {
    { "swap", _wrap_swap},
    { "array_write7", _wrap_array_write7},
    { "array_write8", _wrap_array_write8},
    { "array_write", _wrap_array_write},
    { "array_write3", _wrap_array_write3},
    { "array_write4", _wrap_array_write4},
    {0,0}
};
